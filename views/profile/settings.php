        ...
        <?php $form = ActiveForm::begin([
            ...
            <div class="photo-editing">
                <div>
                    ...
                    <img class="avatar-preview" src="<?= $model->avatarPath; ?>" width="83" height="83" alt="<?= $model->full_name; ?>">
                </div>
                <?= $form->field($model, 'avatar', ['options' => ['tag' => false]])->fileInput(['hidden' => true, 'id' => 'button-input'])->label('Сменить аватар', ['class' => 'button button--black']); ?>
            </div>
            ...
            <div class="half-wrapper">
                <?= $form->field($model, 'phone')->textInput(['type' => 'tel', 'maxlength' => 11, 'pattern' => '\d{6,}', 'title' => 'Поле телефон должно содержать от 6 до 11 цифр, без использования специальных знаков']); ?>
