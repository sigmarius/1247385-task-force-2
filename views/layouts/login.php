...
use yii\helpers\Url;
use Taskforce\Service\Enum\FlashTypes;
    ...
    <main>
        <?php if (!empty(Yii::$app->session->getAllFlashes())): ?>
            <?php foreach (Yii::$app->session->getAllFlashes() as $key => $message): ?>
                <?php if (in_array($key, FlashTypes::values())): ?>
        ...
        <div class="main-container page-footer__container">
            <div class="page-footer__info">
                ...
                <p class="page-footer__info-use">
                    ...
                    <a href="mailto:mail@taskforce.com">mail@taskforce.com</a>
                </p>
            </div>
            ...
            <div class="page-footer__copyright">
                <a href="https://htmlacademy.ru" target="_blank">
                    <img class="copyright-logo"
                         src="<?= Yii::getAlias('@web/img/academy-logo.png'); ?>"
                         width="185" height="63"
